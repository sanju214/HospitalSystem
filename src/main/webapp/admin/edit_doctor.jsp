            ...
            <div class="card paint-card">
                <div class="card-body">
                    ...
                    <form action="../updateDoctor" method="post">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Qualification</label> <input type="text" required name="qualification" class="form-control" value="<%= d.getQualification() %>">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Email</label> <input type="email" required name="email" class="form-control" value="<%= d.getEmail() %>">
                        ...
                        <div class="mb-3">
                            <label class="form-label">password</label> <input type="text" required name="password" class="form-control" value="<%= d.getPassword() %>">
